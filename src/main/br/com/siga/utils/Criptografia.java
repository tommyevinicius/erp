...
public class Criptografia {
	...
	/**
	 * Criptografa em SHA-1, lança RuntimeException caso não encontre o algoritmo de criptografia especificado
	 * 
	 * @param valor
	 * @return
	 */
	...
	/**
	 * Realiza um digest em um array de bytes através do algoritmo especificado Exemplo:
	 * senhaEncriptada.equals(CriptoUtil.byteArrayToHexString(CriptoUtil.digest(senhaNaoEncriptada.getBytes(),"SHA-1")))
	 * 
	 * @param input
	 *            - O array de bytes a ser criptografado
	 * @param algoritmo
	 *            - O algoritmo a ser utilizado (SHA / MD5)
